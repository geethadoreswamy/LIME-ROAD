      ...
      fetch("/imagesData.json")
        ...
        .then((data) => {
          if (categoryName) {
            ...
            const categoryProducts = data.products.WOMEN[categoryKey] || [];
            setProducts(categoryProducts);
            setFilteredProducts(categoryProducts);
          } else {
            const allProducts = Object.values(data.products.WOMEN).flat();
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div className="products-page">
        <h1>{categoryName ? categoryName.toUpperCase() : "ALL WOMEN'S PRODUCTS"}</h1>
