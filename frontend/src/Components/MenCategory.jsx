      ...
      fetch("/menData.json")
        ...
        .then((data) => {
          if (categoryName) {
            ...
            const categoryProducts = data.products.MEN[categoryKey] || [];
            setProducts(categoryProducts);
            setFilteredProducts(categoryProducts);
          } else {
            const allProducts = Object.values(data.products.MEN).flat();
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div className="products-page">
        <h1>{categoryName ? categoryName.toUpperCase() : "ALL MEN'S PRODUCTS"}</h1>
